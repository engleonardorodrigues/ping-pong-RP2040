...
0x00, 0x18, 0x24, 0x20, 0x70, 0x20, 0x20, 0x00, // f
0x00, 0x00, 0x3C, 0x44, 0x44, 0x3C, 0x04, 0x38, // g
0x00, 0x40, 0x40, 0x58, 0x64, 0x44, 0x44, 0x00, // h
0x00, 0x00, 0x20, 0x00, 0x60, 0x20, 0x20, 0x70, // i
0x00, 0x00, 0x10, 0x00, 0x30, 0x10, 0x10, 0x60, // j
0x00, 0x40, 0x40, 0x44, 0x48, 0x70, 0x48, 0x44, // k
0x00, 0x60, 0x20, 0x20, 0x20, 0x20, 0x20, 0x70, // l
0x00, 0x00, 0x68, 0x94, 0x94, 0x94, 0x94, 0x00, // m
...
0x00, 0x00, 0x82, 0x92, 0xAA, 0x44, 0x00, 0x00, // w 
...
void ssd1306_draw_char(ssd1306_t *ssd, char c, uint8_t x, uint8_t y) {
    ...
    if (c >= '0' && c <= '9') {
        index = (c - '0') * 8 + 8;  // Numbers start at index 8
    }
    else if (c >= 'A' && c <= 'Z') {
        index = (c - 'A' + 11) * 8;  // A-Z start at index 88
    }
    else if (c >= 'a' && c <= 'z') {
        index = (c - 'a' + 37) * 8;  // a-z start at index 296
    }
